...
APPLICATION_DIRECTORY_NAME = "cari"
WINDOWS_APPLICATION_DIRECTORY_NAME = "Cari"
DATABASE_FILENAME = "cari.db"
...
def get_application_data_directory(
    *,
    ...
    """Return the platform-specific Cari data directory without creating it."""
